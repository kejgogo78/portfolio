...
export default function BusinessCoupons() {
    ...
    const handleChange = (selected: SingleValue<OptionType>) => {
        setSearchType(selected?.value || 'coupon');
    };*/
    ...
    const fetchData = async (search: SearchCoupon) => {
        setIsLoading(false);
        const result = await fetchPartnerCoupons(search); //api 호출
        if (result.success) {
                ...
                <div id="kt_app_content_container" className="app-container container-xxl">
                    <div className="card">
                        ...
                        <div className="card-body pt-0">
                            {/* 테이블 
                            <PartnerCouponTable coupons={coupons} total={total} currentPage={page} pageSize={pageSize}
